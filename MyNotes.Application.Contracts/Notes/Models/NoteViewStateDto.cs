...
internal sealed record NoteViewStateDto
{
  ...
  public required AlignmentPosition BackgroundImageAlignment { get; init; }

  public required double BackgroundImageOpacity { get; init; }

  public required double BackgroundImageBlur { get; init; }

  public required BackdropKind BackdropKind { get; init; }
