...
internal static class AppSettingsDescriptors
{
  ...
  public static SettingsDescriptor<Guid> InitialPageId { get; } = new("InitialPageId", NavigationId.Home.Value);
  ...
  public static SettingsDescriptor<int> NoteBackdropKind { get; } = new("NoteBackdropKind", (int)Models.Notes.BackdropKind.None);
  ...
  public static SettingsDescriptor<int> GroupIconBadge { get; } = new("GroupIconBadge", (int)Models.Settings.GroupIconBadge.Folder);

  public static SettingsDescriptor<bool> AllowCustomNoteSortOrder { get; } = new("AllowCustomSortOrder", true);
  public static SettingsDescriptor<int> NoteSortKey { get; } = new("NoteSortKey", (int)Models.Notes.NoteSortKey.Created);
  ...
  public static SettingsDescriptor<int> PreviewLayoutType { get; } = new("PreviewLayoutType", (int)Models.Navigations.PreviewLayoutType.Grid);
  public static SettingsDescriptor<int> PreviewTileSize { get; } = new("PreviewTileSize", (int)Models.Navigations.PreviewTileSize.Medium);
  public static SettingsDescriptor<int> PreviewTileRatio { get; } = new("PreviewTileRatio", (int)Models.Navigations.PreviewTileRatio.Square);
}