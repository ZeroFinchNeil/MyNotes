...
public sealed partial class SubtleIconSplitButton : Button
{
  ...
  public static readonly DependencyProperty IconViewBoxWidthProperty = DependencyProperty.Register("IconViewBoxWidth", typeof(double), typeof(SubtleIconSplitButton), new PropertyMetadata(double.NaN));
  ...
  public static readonly DependencyProperty IconViewBoxHeightProperty = DependencyProperty.Register("IconViewBoxHeight", typeof(double), typeof(SubtleIconSplitButton), new PropertyMetadata(double.NaN));
