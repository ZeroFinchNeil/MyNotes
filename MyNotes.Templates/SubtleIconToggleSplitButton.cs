...
public sealed partial class SubtleIconToggleSplitButton : ToggleButton
{
  ...
  public static readonly DependencyProperty IconViewBoxWidthProperty = DependencyProperty.Register("IconViewBoxWidth", typeof(double), typeof(SubtleIconToggleSplitButton), new PropertyMetadata(double.NaN));
  ...
  public static readonly DependencyProperty IconViewBoxHeightProperty = DependencyProperty.Register("IconViewBoxHeight", typeof(double), typeof(SubtleIconToggleSplitButton), new PropertyMetadata(double.NaN));
